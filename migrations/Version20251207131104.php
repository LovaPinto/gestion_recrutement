 ...
 */
final class Version20251207131104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE department DROP INDEX UNIQ_CD1DE18A979B1AD6, ADD INDEX IDX_CD1DE18A979B1AD6 (company_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE department DROP INDEX IDX_CD1DE18A979B1AD6, ADD UNIQUE INDEX UNIQ_CD1DE18A979B1AD6 (company_id)');
