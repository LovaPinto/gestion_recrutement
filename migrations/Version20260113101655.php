 ...
 */
final class Version20260113101655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidacy ADD ats_score DOUBLE PRECISION DEFAULT NULL, ADD cv_mime_type VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidacy DROP ats_score, DROP cv_mime_type');
