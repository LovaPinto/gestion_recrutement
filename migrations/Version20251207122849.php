 ...
 */
final class Version20251207122849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_offer (id INT AUTO_INCREMENT NOT NULL, offer_type VARCHAR(50) NOT NULL, description VARCHAR(50) NOT NULL, date_creation DATE NOT NULL, deadline DATE NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_288A3A4EA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
