 ...
 */
final class Version20251223150123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD job_skills JSON NOT NULL, ADD status VARCHAR(255) NOT NULL, ADD experience_level VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer DROP job_skills, DROP status, DROP experience_level');
