 ...
 */
final class Version20251228045130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE new_user (id INT AUTO_INCREMENT NOT NULL, nom_complet VARCHAR(250) NOT NULL, email VARCHAR(250) NOT NULL, mdp VARCHAR(50) NOT NULL, company_id INT NOT NULL, INDEX IDX_797E6294979B1AD6 (company_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE role ADD new_user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE role ADD CONSTRAINT FK_57698A6A7C2D807B FOREIGN KEY (new_user_id) REFERENCES new_user (id)');
        $this->addSql('CREATE INDEX IDX_57698A6A7C2D807B ON role (new_user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE role DROP FOREIGN KEY FK_57698A6A7C2D807B');
        $this->addSql('DROP INDEX IDX_57698A6A7C2D807B ON role');
        $this->addSql('ALTER TABLE role DROP new_user_id');
