 ...
 */
final class Version20260105094651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate DROP status, DROP user_id, DROP nom, DROP prenom, DROP email, DROP telephone, DROP adresse, DROP ville, DROP code_postal, DROP linkedin, DROP facebook, DROP nationalite, DROP genre, DROP date_naissance, DROP password, CHANGE cv_file cv_file LONGBLOB NOT NULL, CHANGE lm_file lm_file LONGBLOB NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_offer_candidate (job_offer_id INT NOT NULL, candidate_id INT NOT NULL, INDEX IDX_80EBBCEF3481D195 (job_offer_id), INDEX IDX_80EBBCEF91BD8781 (candidate_id), PRIMARY KEY (job_offer_id, candidate_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('ALTER TABLE candidacy DROP FOREIGN KEY FK_D930569D3481D195');
        $this->addSql('ALTER TABLE candidate ADD status VARCHAR(50) DEFAULT NULL, ADD user_id INT NOT NULL, ADD nom VARCHAR(191) DEFAULT NULL, ADD prenom VARCHAR(191) DEFAULT NULL, ADD email VARCHAR(191) NOT NULL, ADD telephone VARCHAR(20) DEFAULT NULL, ADD adresse VARCHAR(191) DEFAULT NULL, ADD ville VARCHAR(191) DEFAULT NULL, ADD code_postal VARCHAR(20) DEFAULT NULL, ADD linkedin VARCHAR(191) DEFAULT NULL, ADD facebook VARCHAR(191) DEFAULT NULL, ADD nationalite VARCHAR(100) DEFAULT NULL, ADD genre VARCHAR(20) DEFAULT NULL, ADD date_naissance DATE DEFAULT NULL, ADD password VARCHAR(255) DEFAULT NULL, CHANGE cv_file cv_file LONGBLOB DEFAULT NULL, CHANGE lm_file lm_file LONGBLOB DEFAULT NULL');
