 ...
 */
final class Version20260106054812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE new_user (id INT AUTO_INCREMENT NOT NULL, nom_complet VARCHAR(250) NOT NULL, email VARCHAR(250) NOT NULL, mdp VARCHAR(50) NOT NULL, date_creation DATETIME NOT NULL, user_status TINYINT NOT NULL, company_id INT NOT NULL, role_id INT NOT NULL, INDEX IDX_797E6294979B1AD6 (company_id), INDEX IDX_797E6294D60322AC (role_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE company ADD email VARCHAR(200) NOT NULL, ADD password VARCHAR(50) NOT NULL, ADD description LONGTEXT NOT NULL, ADD date_creation DATETIME NOT NULL, ADD status TINYINT NOT NULL, ADD role_id INT NOT NULL, DROP localisation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company ADD localisation VARCHAR(100) DEFAULT NULL, DROP email, DROP password, DROP description, DROP date_creation, DROP status, DROP role_id');
