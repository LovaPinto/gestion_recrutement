 ...
 */
final class Version20260106190824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidacy ADD user_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_D930569DA76ED395 ON candidacy (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D930569DA76ED395 ON candidacy');
        $this->addSql('ALTER TABLE candidacy DROP user_id');
