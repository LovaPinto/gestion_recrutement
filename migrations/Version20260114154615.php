 ...
 */
final class Version20260114154615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidacy CHANGE status status VARCHAR(50) DEFAULT \'en attente\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidacy CHANGE status status VARCHAR(20) DEFAULT \'pending\' NOT NULL');
