 ...
 */
final class Version20251231163441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company CHANGE company_name company_name VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company CHANGE company_name company_name VARCHAR(50) NOT NULL');
