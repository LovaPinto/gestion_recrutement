 ...
 */
final class Version20251231162746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer CHANGE deadline deadline DATE DEFAULT NULL, CHANGE job_skills job_skills JSON DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer CHANGE deadline deadline DATE NOT NULL, CHANGE job_skills job_skills JSON NOT NULL');
